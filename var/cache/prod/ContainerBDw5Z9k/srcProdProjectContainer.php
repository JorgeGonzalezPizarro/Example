...
class srcProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            ...
            'anuncio.controller' => 'getAnuncio_ControllerService.php',
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'env(DATABASE_URL)' => 'DATABASE_URL=mysql://root:@127.0.0.1:3306/example',
            ...
            'doctrine.dbal.connection_factory.types' => array(
                'TypeAlto' => array(
                    'class' => 'App\\Domain\\Anuncios\\Domain\\Component\\Components\\CustomTypes\\TypeAlto',
                    'commented' => true,
                ),
            ),
