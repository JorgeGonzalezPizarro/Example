...
return $this->privates['App\Domain\Anuncios\UseCases\Create\CreateAnuncioHandler'] = new \App\Domain\Anuncios\UseCases\Create\CreateAnuncioHandler(new \App\Domain\Anuncios\UseCases\Create\AnuncioCreator(($this->privates['anuncio_repository_doctrine'] ?? $this->load('getAnuncioRepositoryDoctrineService.php')), ($this->privates['components_repository_doctrine'] ?? $this->load('getComponentsRepositoryDoctrineService.php')), new \App\IO\Events\DomainEventPublisherRabbitMq()));
