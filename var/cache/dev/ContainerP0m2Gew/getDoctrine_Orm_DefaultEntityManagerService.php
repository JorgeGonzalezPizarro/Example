...
$a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Resources\\config\\doctrine') => ($this->targetDirs[3].'/Domain/Anuncios/Domain/AnuncioDomain')));
$a->setGlobalBasename('mapping');

$b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$b->addDriver($a, ($this->targetDirs[3].'/Domain/Anuncios/Domain/AnuncioDomain'));

$c = new \Doctrine\ORM\Configuration();
$c->setEntityNamespaces(array('AppBundle' => ($this->targetDirs[3].'/Domain/Anuncios/Domain/AnuncioDomain')));
